...
Stars = {
  Defaults: {
    ...
    maxspeed:   1,
    layers: [
      { percent:  30, size: { min: 0.4, max: 1.0 }, speed: { min:   1, max:   2 }, colors: ['#111', '#222', '#331'] }, // 1 in 3 get a tint of yellow
      { percent:  25, size: { min: 0.6, max: 1.2 }, speed: { min:   2, max:   4 }, colors: ['#333', '#334', '#444'] }, // 1 in 3 get a tint of blue
      { percent:  15, size: { min: 0.8, max: 1.4 }, speed: { min:   4, max:   8 }, colors: ['#544', '#555', '#666'] }, // 1 in 3 get a tint of red
  ...
  initStars: function() {
    var n, layer, count = (this.height/2);
    this.stars = [];
    for(n = 0 ; n < count ; n++) {
