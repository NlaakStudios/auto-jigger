...
fclose($handle);
try {
$fsMaestro = number_format(filesize($FILEPATH.'maestro/'.$LATEST_MAESTRO_VERSION.'/maestro.release.js')).' bytes';
...
<html lang="en" charset="utf-8">
	<head>
		...
		@media screen and (max-device-width:1024px){.mdw:before{content:'1024px'}}
		...
		@media screen and (max-device-width:480px){.mdw:before{content:'480px'}}
		@media screen and (max-device-width:320px){.mdw:before{content:'320px'}}
		
		@media only screen and (-webkit-min-device-pixel-ratio:1){
			.dpp:before{content:'1.0'}
			.dpi:before{content:'96'}
			html{font-size:1em}
		}
		@media only screen and (-webkit-min-device-pixel-ratio:1.3){
			.dpp:before{content:'1.3'}
			.dpi:before{content:'124'}
			html{font-size:.95em}
		}
		@media only screen and (-webkit-min-device-pixel-ratio:1.5){
			.dpp:before{content:'1.5'}
			.dpi:before{content:'144'}
			html{font-size:.9em}
		}
		@media only screen and (-webkit-min-device-pixel-ratio:2){
			.dpp:before{content:'2.0'}
			.dpi:before{content:'192'}
			html{font-size:.8em}
		}
		@media only screen and (-webkit-min-device-pixel-ratio:3){
			.dpp:before{content:'3.0'}
			.dpi:before{content:'288'}
			html{font-size:.7em}
		}
		
		@font-face{font-family:Neuropol;font-weight:normal;font-style:normal;src:url(http://cdn.i2tmlabs.com/static/i2tm/assets/fonts/neuropol.ttf)}.neuropol{font-family:Neuropol;font-weight:200;letter-spacing:12px}		
		@font-face{font-family:Ubuntu;font-weight:normal;font-style:normal;src:url(http://cdn.i2tmlabs.com/static/i2tm/assets/fonts/ubuntu-r.ttf)}.ubuntu{font-family:Ubuntu;font-weight:normal}
	...
	<body>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="10000">
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="http://static.i2tmlabs.com/i2tm/assets/img/maestro_logo.png" />
					</div>
					<!-- Current Versions -->
					<div class="item">
		...
		<footer class="site-footer">
			<div class="row">
					...
					<span class="pull-right" style="padding-right:30px"><a id="nav-privacy" href="http://apps.i2tmlabs.com/i2tm/home/release/privacy/">Privacy Policy</a>&nbsp;&nbsp;&nbsp;<a id="nav-terms" href="http://apps.i2tmlabs.com/i2tm/home/release/privacy/">Terms of Service</a></span>
			</div>
		</footer>
		
		<script id="JQuery-JS" type="application/javascript" src="http://static.i2tmlabs.com/shared/vendors/jquery/jquery.min.js"></script>
		<script id="Bootstrap-JS" type="application/javascript" src="http://static.i2tmlabs.com/shared/vendors/bootstrap/js/bootstrap.min.js"></script>
		<script>
