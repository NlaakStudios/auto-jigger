...
H5C3CFG = {
	...
	/* 
	 ...
	 Mode 1 - Load Engine, Framework in support of embeded WebApp (part of a HTML page)
	 */
	rwdOnly: true,
	
	devMode: true,
	
	launch: 'test/applet.intro.html',
	...
	options: {
		 ...
		 */
		path: 'http://i2tmlabs.com/sandbox/compiler/',
	...
	applets: [],
	/** List all javascript files your application will require. (main.js is required) */
	files:[],
...
if("undefined"===typeof h5c3){
	...
	s.type="text/javascript";
		   ///Android_Dev/GitHUB/com.I2TMLabs.h5c3/public/sandbox/assets/js/h5c3.debug.cat.js
	s.src='../assets/js/h5c3.debug.cat.js';
