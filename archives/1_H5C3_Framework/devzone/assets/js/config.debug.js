...
H5C3CFG = {
	...
	options: {	
		 ...
		 *	Mode: Both
		 */
		path: 'http://h5c3.i2tmlabs.com/public/sandbox/devzone/assets/',
	 ...
	 *	Mode: Both
	 */
	//files:['assets/js/src-min-noconflict/ace.js'],//'require.js'
	files:['src-min-noconflict/ace.js','ide.js'],
...
if("undefined"===typeof h5c3){
	...
	//s.src='http://h5c3.i2tmlabs.com/public/shared/js/int/h5c3.debug.min.js';
