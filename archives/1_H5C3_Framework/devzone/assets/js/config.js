...
H5C3CFG = {
	 ...
	 *	Mode: Both
	 */
	files:['src-min-noconflict/ace.js','i2tm-compiler.js'],//'require.js'
...
/* DO NOT ALTER BELOW - Loads correct h5c3 API depending on your configuration settings */
if("undefined"===typeof h5c3){var z=(H5C3CFG.devMode)?'debug':'prod',a=document.createElement("script");a.type="text/javascript";a.src="http://h5c3.i2tmlabs.com/public/shared/js/int/h5c3."+z+".min.js";document.getElementsByTagName("head")[0].appendChild(a)};
/* DO NOT ALTER ABOVE LINE */