/*
 ...
 Built Sun Sep 15 13:01:39 2013
...
k="",l,n=Math.min(e,20),m,p=0;p<n;++p)if(l=b[e-p-1],m=l.indexOf("//"),0<=m&&(l=l.substr(0,m)),l)if(k=l+k,(l=g.exec(k))&&l[1]||(l=f.exec(k))&&l[1]||(l=h.exec(k))&&l[1])return l[1];return"(?)"}};return b});window.$DOC=function(){return window.document};window.$GQS=function(b,c,e){$CHK(e,$DOC());return e.querySelector("div[data-"+b+'="'+c+'"]')};window.$GEI=function(b){return $DOC().getElementById(b)};window.$GEN=function(b){return $DOC().getElementsByName(b)};window.$GEC=function(b){return $DOC().getElementsByClass(b)};
window.$GET=function(b){return $DOC().getElementsByTagName(b)};window.$CNT=function(b){return"string"===typeof b?$GEI(b):b};window.$CTX=function(b){return $CNT(b).getContext("2d")};window.$ESA=function(b,c,e){$CNT(b).setAttribute(c,e)};window.$EGA=function(b,c){$CNT(b).getAttribute(c)};window.$AEA=function(b,c,e,f){var g=$CNT(b);c=$DOC().createElement(c);e&&(c.id=e);f&&(c.innerHTML=f);g.parentNode.insertBefore(c,b);return g.parentNode.id};
window.$AET=function(b,c,e,f){b=$CNT(b);c=$DOC().createElement(c);e&&(c.id=e);f&&(c.innerHTML=f);b.appendChild(c);return c};
window.$PUW=function(b,c,e,f,g){var h=window.screen.availWidth/2-f/2,k=window.screen.availHeight/2-g/2;!0===e?(b=window.open(b,c,"toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no"),b.moveTo(0,0),b.resizeTo(window.screen.availWidth,window.screen.availHeight)):b=window.open(b,c,"toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width="+f+", height="+g+", top="+k+", left="+h);b&&!b.closed&&
"undefined"!==b.closed&&0!==b.screenX||window.alert("Please change your popup settings for this domain.");return b};window.$VLD=function(b){return!(null===b||"undefined"===b||void 0===b||""===b)};window.$CHK=function(b,c){return $VLD(b)?b:c};window.$AST=function(b,c){if(!b)throw c;};window.$RUN=function(b){$VLD(h5c3.bootstrap)&&h5c3.applets.use({file:b})};
...
e+=3);return c.join("")}},h5c3={_CLASSNAME:"H5C3",_CLASSVERSION:"0.5.1",NAME:"H5C3 Framework",VERSION:"0.9.9-alpha",DISTRO:"Production",BUILT:"Sun Sep 15 13:01:39 2013",path:{home:"http://h5c3.i2tmlabs.com/",base:"public/sandbox/",applets:"public/applets/",scripts:"public/shared/js/",styles:"public/shared/css/",images:"public/shared/img/",plugins:"public/shared/plugins/",user:"public/users/",app:window.location.protocol+"//"+window.location.host+window.location.pathname.split("/").slice(0,-1).join("/")+
"/"},hasOwn:Object.prototype.hasOwnProperty,isH5C3:function(b){return"object"===typeof b&&"function"===typeof b.isH5C3},isFunction:function(b){return!!(b&&b.constructor&&b.call&&b.apply)},isWindow:function(b){return!(!b||!b.setInterval)},isArray:Array.isArray||function(b){return b.constructor===Array},isString:function(b){return"string"==typeof b},isObject:function(b){return b===Object(b)},isPlainObject:function(b){if(!b||this.isObject(b)||b.nodeType||this.isWindow(b))return!1;try{if(b.constructor&&
!this.hasOwn.call(b,"constructor")&&!this.hasOwn.call(b.constructor.prototype,"isPrototypeOf"))return!1}catch(c){return!1}for(var e in b);return void 0===e||this.hasOwn.call(b,e)},bind:function(b,c){return function(){c.apply(b,arguments)}},extend:function(){var b,c,e,f,g,h=arguments[0]||{},k=1,l=arguments.length,n=!1;"boolean"===typeof h&&(n=h,h=arguments[1]||{},k=2);"object"===typeof h||h5c3.isFunction(h)||(h={});l===k&&(h=this,--k);for(;k<l;k++)if(null!=(b=arguments[k]))for(c in b)e=h[c],f=b[c],
h!==f&&(n&&f&&(this.isPlainObject(f)||(g=this.isArray(f)))?(g?(g=!1,e=e&&this.isArray(e)?e:[]):e=e&&this.isPlainObject(e)?e:{},h[c]=this.extend(n,e,f)):void 0!==f&&(h[c]=f));return h},devMode:!1,ready:!1,init:function(){var b;b="No Configuration file detected.\nYour very first script tag should be as below. You can change the path/file for the data-config attribute.\n"+('EXAMPLE: <script src="'+this.usePath("script")+'int/h5c3.debug.min.js" data-config="assets/config.js">\x3c/script>');if(config&&
config.app&&config.options)this.config=config,this.ready=!0;else if($AST(!this.getConfig(),b))return this.ready;this.devMode="Developer"===this.DISTRO||"Production"===this.DISTRO?!0:!1;return this.ready},usePath:function(b){switch(b.toLowerCase()){case "home":return this.path.home;case "base":return this.path.home+path.base;case "applets":return this.path.home+path.applets;case "scripts":return this.path.home+path.scripts;case "styles":return this.path.home+path.styles;case "images":return this.path.home+
path.images;case "plugins":return this.path.home+path.plugins;case "user":return this.path.home+path.user;case "app":return this.path.app}},getConfig:function(){if("file:"!==location.protocol&&"undefined"===typeof this.config){var b=document.getElementsByTagName("script")[0];if(0===b.children.length)b.dataset.config&&(this.path.config=this.path.app+b.dataset.config);else for(i=0;i<b.children.length;i++)b.children[i].dataset.config&&(this.path.config=this.path.app+b.children[i].dataset.config);this.path.config&&
this.XHR(this.path.config)}},tag:function(){return this.NAME+" v"+this.VERSION+"-"+this.DISTRO},XHR:function(b,c,e,f,g,h){function k(b){b.req=printStackTrace.implementation.prototype.createXMLHTTPObject();if("withCredentials"in b.req){b.req.open(b.method,b.url,!0);b.req.onerror=b.onError;b.req.onreadystatechange=function(){if(4===b.req.readyState)if(200<=b.req.status&&400>b.req.status)b.onLoad(b.req.responseText);else b.req.abort()};try{b.req.send(b.data)}catch(c){$AST(null,printStackTrace({e:c}))}}}
function l(b){b.req=new XDomainRequest;b.req.open(b.method,b.url);b.req.onerror=b.onError;b.req.onload=function(){c(b.req.responseText)};b.req.send(b.data)}if($VLD(b)&&""!==b){h=h5c3.devMode&&!0!=h?!1:!0;g={req:"",url:b,trace:h};g.method=$CHK(f,"GET");g.onLoad=$CHK(c,this._onLoad);g.onError=$CHK(e,this._onError);g.data=$CHK(e,0);b.indexOf("http");a=b.indexOf("applet.");try{if(XMLHttpRequest)return k(g);if(XDomainRequest)return l(g)}catch(n){}}else e(Error("URL provided is invalid ["+b+"]"))},clientFS_exists:function(b,
c){storageRootEntry.getFile(b,{create:!1},function(){c(!0)},function(){c(!1)})},run:function(){$VLD(this.bootstrap)||(this.bootstrap=new h5c3.Bootstrap)}};h5c3.push=Array.prototype.push;h5c3.merge=function(b,c){var e=b.length,f=0;if("number"===typeof c.length)for(var g=c.length;f<g;f++)b[e++]=c[f];else for(;void 0!==c[f];)b[e++]=c[f++];b.length=e;return b};
h5c3.makeArray=function(b,c){var e=c||[];null!=b&&(null==b.length||h5c3.isString(b)||h5c3.isFunction(b)||h5c3.isWindow(b)?h5c3.push.call(e,b):h5c3.merge(e,b));return e};h5c3.each=function(b,c,e){var f,g=0,h=b.length,k=void 0===h||h5c3.isFunction(b);if(e)if(k)for(f in b){if(!1===c.apply(b[f],e))break}else for(;g<h&&!1!==c.apply(b[g++],e););else if(k)for(f in b){if(!1===c.call(b[f],f,b[f]))break}else for(;g<h&&!1!==c.call(b[g],g,b[g++]););return b};h5c3._flagsCache={};
h5c3.createFlags=function(b){var c=h5c3._flagsCache[b]={},e,f;b=b.split(/\s+/);e=0;for(f=b.length;e<f;e++)c[b[e]]=!0;return c};
h5c3.Callbacks=function(b){b=b?h5c3._flagsCache[b]||h5c3.createFlags(b):{};var c=[],e=[],f,g,h,k,l,n=function(e){var f,g,h;f=0;for(g=e.length;f<g;f++)h=e[f],h5c3.isArray(h)?n(h):h5c3.isFunction(h)&&(b.unique&&p.has(h)||c.push(h))},m=function(m,r){r=r||[];f=!b.memory||[m,r];g=!0;l=h||0;h=0;for(k=c.length;c&&l<k;l++)if(!1===c[l].apply(m,r)&&b.stopOnFalse){f=!0;break}g=!1;c&&(b.once?!0===f?p.disable():c=[]:e&&e.length&&(f=e.shift(),p.fireWith(f[0],f[1])))},p={add:function(){if(c){var b=c.length;n(arguments);
...
arguments):this.Class.newInstance.apply(this.Class,arguments)}catch(b){return null}}"string"!=typeof b&&(g=f,f=b,b=null);g||(g=f,f=null);g=g||{};var s=this.prototype,q,u,y,v;this.isA=function(b){return-1!=this._fullTypeName.indexOf("|"+b+"|")};c=!0;v=new this;c=!1;n(g,s,v);for(q in this)this.hasOwnProperty(q)&&(l[q]=k(this[q]));n(f,this,l);b&&(s=b.split(/\./),u=s.pop(),q="",0<s.length&&(y=q=m.getObject(s.join("."),window,!0)),q[u]=l);h(l,{prototype:v,namespace:y,shortName:u,constructor:l,fullName:b});
l.prototype.Class=l.prototype.constructor=l;u=l.setup.apply(l,[this].concat(e(arguments)));l.init&&l.init.apply(l,u||[]);return l}});m.prototype.callback=m.callback})(h5c3);
...
}}function g(b,c,e,f){this[0]=b;this.entries=[];this.addEntry(c,e);null!==f&&(this.getEqualityFunction=function(){return f})}function h(b){return function(c){for(var e=this.entries.length,f,g=this.getEqualityFunction(c);e--;)if(f=this.entries[e],g(c,f[0]))switch(b){case x:return!0;case s:return f;case q:return[e,f[1]]}return!1}}function k(b){return function(c){for(var e=c.length,f=0,g=this.entries.length;f<g;++f)c[e+f]=this.entries[f][b]}}function l(b,c){var e=b[c];return e&&e instanceof g?e:null}
function n(c,e){var f=this,h=[],k={},q=typeof c==m?c:b,s=typeof e==m?e:null;this.put=function(b,c){t(b);r(c);var e=q(b),f,m=null;(f=l(k,e))?(e=f.getEntryForKey(b))?(m=e[1],e[1]=c):f.addEntry(b,c):(f=new g(e,b,c,s),h[h.length]=f,k[e]=f);return m};this.get=function(b){t(b);var c=q(b);if(c=l(k,c))if(b=c.getEntryForKey(b))return b[1];return null};this.containsKey=function(b){t(b);var c=q(b);return(c=l(k,c))?c.containsKey(b):!1};this.containsValue=function(b){r(b);for(var c=h.length;c--;)if(h[c].containsValue(b))return!0;
return!1};this.clear=function(){h.length=0;k={}};this.isEmpty=function(){return!h.length};var w=function(b){return function(){for(var c=[],e=h.length;e--;)h[e][b](c);return c}};this.keys=w("keys");this.values=w("values");this.entries=w("getEntries");this.remove=function(b){t(b);var c=q(b),e=null,f=l(k,c);if(f&&(e=f.removeEntryForKey(b),null!==e&&!f.entries.length)){a:{for(b=h.length;b--;)if(f=h[b],c===f[0])break a;b=null}p(h,b);delete k[c]}return e};this.size=function(){for(var b=0,c=h.length;c--;)b+=
...
window.h5c3.ErrorHandler=h5c3.Base.extend("h5c3.ErrorHandler",{_CLASSNAME:"ErrorHandler",_CLASSVERSION:"0.1.0",tag:function(){return this._CLASSNAME+" v"+this._CLASSVERSION}},{ready:!1,errArgs:null,done:!1,total:0,currOurs:!1,currType:null,currMSG:!1,currStack:!1,currCaller:!1,whoName:"",whoPath:"",init:function(){this._super();$DOC().addEventListener("H5C3Error",h5c3.bind(this,this.onH5C3Error),!1);this.ready=!0},reset:function(){this.total=0;this.currOurs=!1;this.currType=-1;this.currMSG="";this.currStack=
!1;this.currCaller=""},who:function(b){$CHK(b,null);"undefined"===typeof b._CLASSNAME?$CHK(this.whoName,"Unknown"):b._fullTypeName?(this.whoName=b.fullName+"-"+b._CLASSVERSION,this.whoPath=b._fullTypeName):(this.whoName=b._CLASSNAME+"-"+b._CLASSVERSION,this.whoPath="h5c3");this.whoName=String.prototype.pad(this.whoName,30);this.whoPath=String.prototype.pad(this.whoPath,50)},what:function(b){switch(b.length){case 1:h5c3.isString(b[0])?(this.currType=0,this.currMSG=b[0]):h5c3.isArray(b[0])?(this.currType=
1,$tmp=b[0].pop(),this.currMSG="undefined"===typeof $tmp.message?$tmp.toString():$tmp.message,this.currStack=b[0],this.who(b.callee.caller)):h5c3.isH5C3(b[0])?this.currType=2:h5c3.isObject(b)?this.currType=3:h5c3.isFunction(b)&&(this.currType=4);break;case 2:h5c3.isString(b[0])&&(h5c3.isH5C3(b[1])||h5c3.isObject(b[1])||h5c3.isFunction(b[1]))&&(this.currType=0,this.who(b[1]),this.currMSG=b[0])}},when:function(){},prepEmail:function(){return'<a href="mailto:support@i2tmlabs.com?subject=H5C3%20Error%20Report&body=What:'+
this.whoName+"\nError:"+this.currMSG+"\nTrace:"+this.currStack.toString()+"\nDistro:"+h5c3.tag()+'\n">Is this our fault? Send It!</a>'},display:function(){switch(this.currType){case 0:console.log("411:%c%s %s > %s","color: green;",this.whoName,this.whoPath,this.currMSG);break;case 1:console.error("911:%cOH SNAP! - Sucks to be you right now.\n%s %s > %s\n%O","color: red;",this.whoName,this.whoPath,this.currMSG,this.currStack)}},onH5C3Error:function(b){this.done=!1;this.reset();this.errArgs=b.arguments;
this.what(this.errArgs);this.display();this.done=!0}});h5c3.errorhandler=new h5c3.ErrorHandler;
window.h5c3.Brand=h5c3.Base.extend("h5c3.Brand",{_CLASSNAME:"Brand",_CLASSVERSION:"0.0.2"},{init:function(){this._super();this.populate()},update:function(){$("#h5c3built").text(h5c3.BUILT);$("#h5c3version").text(h5c3.DISTRO+"-"+h5c3.VERSION);!0===h5c3.devMode?$("#h5c3version").css("color","#FF0000"):$("#h5c3version").css("color","#ddffdd")},populate:function(){var b;b='<style id="h5c3-logo">#h5c3_logo {font-size:1em;display: block;}#hlmc {position: relative;display:block;top:0px;left:0px;width:100%;height:100%;font-family: Neuropol, sans-serif;text-transform: uppercase;text-align: center;\tpadding-top:6.25%;}#h5c3_logo .c_H { display:inline; font-size: 100%; color: #e98900; }#h5c3_logo .c_5 { display:inline; font-size: 50%; color: #e98900; }#h5c3_logo .c_C { display:inline; font-size: 100%; color: #000beb; }#h5c3_logo .c_3\t{ display:inline; font-size: 50%; color: #000beb; }#h5c3_logo .w_FW { display:block; font-size: 42%; color: #444444;}</style>\n';b+=
'@charset "UTF-8";#i2tm_logo{font-size:3em;display:block;}#i2tm_logo .w_IL{display:inline;font-size:100%;color:#00cc00;}';b+="#ilmc {position:relative;display:block;top:0px;left:0px;width:100%;height:100%;font-family:Neuropol,sans-serif;text-transform:uppercase;text-align:center;padding-top:6.25%;}</style>\n";h5c3.stylesheet.add("brand-logos",b,"R2WL")},logoI2TM:function(b){b=$CHK(b,3);$("#i2tm_logo").css("font-size",b+"em");return'<div id="i2tm_logo" data-role="applet"><div id="ilmc"><div class="w_il backlight">i2tm Labs</div></div></div>\n'},
logoH5C3:function(b){b=$CHK(b,3);$("#h5c3_logo").css("font-size",b+"em");return'<div id="h5c3_logo" class="animateIn" data-role="applet"><div id="hlmc"><div class="c_H emboss backlight">H</div><div class="c_5 emboss backlight">5</div><div class="c_C emboss backlight">C</div><div class="c_3 emboss backlight">3</div><div class="w_FW emboss backlight">framework</div></div></div>\n'},poweredBy:function(){return'<span style="font-size:0.5em;color:'+(h5c3.devMode?"red":"green")+';letter-spacing:0.20em">Powered By '+
h5c3.tag()+"</span>"},onReady:function(){this.update()}});
...
clear:function(){this.items={};this.length=0}});h5c3.AccuTimer=function(b,c,e,f){function g(){if(l++>=h)f(h,l);else{e(h,l,c);var b=(new Date).getTime()-n-l*k;window.setTimeout(g,k-b)}}0>=b&&(b=864E5);0>=c&&(c=1);var h=b/100*(c/10),k=b/h,l=0,n=(new Date).getTime();window.setTimeout(g,k)};h5c3.CallMebackIn=function(b,c){if($VLD(c))return window.setTimeout(c,b)};
h5c3.FactoryWorker=h5c3.Pooled.extend("h5c3.Applet",{_CLASSNAME:"FactoryWorker",_CLASSVERSION:"0.1.3",_lastUsed:0,create:function(b){var c=this._super();return c.parse(b)?c:c.name}},{});
...
window.h5c3.Throttle=h5c3.Base.extend("h5c3.Throttle",{_CLASSNAME:"Throttle",_CLASSVERSION:"0.1.0",_style:h5c3.THROTTLESTYLE.STRICT,_AEPS:0,_current:0,_maximum:0,_minumum:0,_average:0,_interval:0,_throttle:null,_que:new h5c3.Hashtable,_reset:function(b,c,e){this._current=this._AEPS=0;this._maximum=b;this._minumum=c;this._average=Math.floor((b+c)/2);this._interval=e},_setStyle:function(b){if(this._style!==b){b<h5c3.THROTTLESTYLE.RELAXED&&(b=h5c3.THROTTLESTYLE.RELAXED);b<h5c3.THROTTLESTYLE.GEEZUS&&
(b=h5c3.THROTTLESTYLE.GEEZUS);this._style=b;switch(b){case THROTTLESTYLE.RELAXED:this._reset(11,20,10);break;case THROTTLESTYLE.STRICT:this._reset(6,10,5);break;case THROTTLESTYLE.AGGRESSIVE:this._reset(2.6,5,2.5);break;case THROTTLESTYLE.GEEZUS:this._reset(0,2.5,1.25)}this._evOnChanged()}},_evOnChanged:function(){this._stop();if("function"===typeof onChanged)this.onChanged(this._style);this._start()},_start:function(){this._running||(this._throttle=new h5c3.AccuTimer(this._interval,this._average,
h5c3.bind(this,this._onProcess),h5c3.bind(this,this._onEvaluate)),this._running=!0)},_stop:function(){this._running&&(delete this._throttle,this._running=!1)},_onProcess:function(){},_onEvaluate:function(){}},{init:function(b){this._super();this._setStyle(b)},add:function(b){var c=Date();c.getTime();c.toTimeString();this.que.put(c,b)},onProcess:function(){},onChanged:function(){}});
h5c3.Bootstrap=h5c3.Base.extend("h5c3.Bootstrap",{_CLASSNAME:"Bootstrap",_CLASSVERSION:"0.2.1"},{$baseUrl:"",$current:0,$finished:!1,$noCacheString:"",$scripts:[],init:function(){this.$loc=this.getFileName();this._BrowserIsChrome();this.setBaseUrl(h5c3.path.home+h5c3.path.scripts+"ext/");$VLD(window.Modernizr)||this.add("modernizr.all.release.js");$VLD(window.jQuery)||this.add("jquery/jquery-1.10.2.min.js");h5c3.devMode&&this.handleFiles();this._start()},prepareRWD:function(){h5c3.loader=new h5c3.Loader;
h5c3.lzw=new h5c3.LZW;h5c3.layout=new h5c3.Layout;h5c3.stylesheet=new h5c3.StyleSheet;h5c3.brand=new h5c3.Brand;h5c3.google=new h5c3.Google("UA-35732532-1");h5c3.resources=new h5c3.Resources;h5c3.loader.start();$(window).load(function(){});$(document).ready(function(){})},createCanvas:function(){var b=$GEI("waDIV"),c=b.clientWidth,b=b.clientHeight,e=window.h5c3.config.screen.target.width,f=window.h5c3.config.screen.target.height,g=$AET("waDIV","canvas","waCANVAS");g.style.width=c+"px";g.style.height=
b+"px";g.style.minWidth=c+"px";g.style.minHeight=b+"px";g.style.maxWidth=c+"px";g.style.maxHeight=b+"px";g.width=e;g.height=f;g.style.background="Black";window.h5c3.config.options.fullscreen&&($DOC().addEventListener("webkitfullscreenchange",h5c3.bootstrap._onFullscreenChange),g.webkitRequestFullScreen());return!0},handleFiles:function(){$VLD(window.h5c3.config)&&(0<window.h5c3.config.files.length&&this.que(window.h5c3.config.files,"assets/js/"),0<window.h5c3.config.plugins.length&&this.loadPlugins(window.h5c3.config.plugins,
h5c3.path.base+h5c3.path.plugins),window.h5c3.config.rwdOnly||this.que(["game.min.js"],"assets/js/"))},getFileName:function(){var b=document.location.href,b=b.substring(0,-1===b.indexOf("#")?b.length:b.indexOf("#")),b=b.substring(0,-1===b.indexOf("?")?b.length:b.indexOf("?"));return b=b.substring(b.lastIndexOf("/")+1,b.length)},_onFullscreenChange:function(){var b=$GEI("waCANVAS");document.mozFullScreen||document.webkitIsFullScreen?(b.style.width=window.screen.width+"px",b.style.height=window.screen.height+
"px"):(b.style.width=window.h5c3.config.screen.width+"px",b.style.height=window.h5c3.config.screen.height+"px")},_BrowserIsChrome:function(){var b=/chrome/.test(window.navigator.userAgent.toLowerCase()),c=$GEI("playnow"),e=$GEI("cantplay");if(null!=c&&null!=e){if(b)return c.style.display="block",e.style.display="none",!0;c.style.display="none";e.style.display="block";return!1}},setDisableCache:function(){this.$noCacheString=h5c3.config.devMode?"?nocache="+Date.now():""},setBaseUrl:function(b){this.$baseUrl=
b},_makeUrl:function(b){return this.$baseUrl+b+this.$noCacheString},add:function(b){this.$scripts.push(this._makeUrl(b))},_start:function(){this.$current=0;this._loadNextScript()},loadScript:function(b,c,e){if(!$VLD(b)||""===b)return!1;b=this._makeUrl(b);var f=$DOC().createElement("script");f.type="application/javascript";f.src=b;f.async=!1;f.onloaded=c;f.onerror=e;$GET("head")[0].appendChild(f)},_loadNextScript:function(){var b=this.$scripts[this.$current],c=window.document.createElement("script");
c.type="application/javascript";c.src=b;c.async=!1;$VLD(b)&&(c.onload=function(){h5c3.bootstrap._checkAllDone()},window.document.getElementsByTagName("head")[0].appendChild(c))},finalize:function(){this.createCanvas()&&(h5c3.device=new h5c3.Device,h5c3.device.boot())},_onReady:function(){h5c3.applets=new h5c3.AppletFactory;this.prepareRWD();if(h5c3.stylesheet.onReady)h5c3.stylesheet.onReady();if(h5c3.layout.onReady)h5c3.layout.onReady();if(h5c3.brand.onReady)h5c3.brand.onReady();if(h5c3.applets.onReady)h5c3.applets.onReady();
if(h5c3.google.onReady)h5c3.google.onReady();$("#OVERLAY").fadeOut(750,"linear",function(){$("#WRAPPER").fadeIn(1500,"ease-in")});"undefined"!=typeof window.H5C3READY&&window.H5C3READY(h5c3.VERSION,window.Modernizr._version,$().jquery)},_checkAllDone:function(){this.$finished||(this.$scripts.length-1===this.$current?(this._onReady(),this.$finished=!0,$VLD(window.h5c3.config.rwdOnly)&&!1===window.h5c3.config.rwdOnly&&this.finalize()):(this.$current++,this._loadNextScript()))},que:function(b,c){var e=
0;this.setBaseUrl(c);for(e=0;e<b.length;e++)this.add(b[e])},loadPlugins:function(b,c){var e=0;this.setBaseUrl(c);for(e=0;e<b.length;e++)this.add(b[e]+".js")}});
window.h5c3.Google=h5c3.Base.extend("h5c3.Google",{_CLASSNAME:"Google",_CLASSVERSION:"0.1.2"},{UID:"",enabled:!1,loaded:!1,version:"",domain:null,gaJsHost:null,init:function(b){this.gaJsHost="https:"==document.location.protocol?"https://ssl.":"http://www.";this.UID=b;"file:"!==document.location.protocol&&this.load(this.gaJsHost+"google-analytics.com/ga.js")},load:function(b){var c=$DOC().createElement("script");c.type="application/javascript";c.src=b;c.async=!0;c.onloaded=h5c3.bind(this,this._onLoaded);
...
getVersion:function(){try{var b=_gat._getTrackerByName();return $VLD(this.version=b._getVersion())}catch(c){return!1}},lookForGoogle:function(){var b=document.getElementsByTagName("script"),c;for(c in b)"undefined"!==typeof b[c].src&&b[c].src.split("?")[0].match(/ga\.js$/)&&(this.loaded=!0,this.getVersion()&&(this.enabled=!0))},_onLoaded:function(){this.google.loaded=!0;this.onReady()},_onError:function(){h5c3.google.loaded=!1;h5c3.google.enabled=!1;this.lookForGoogle();h5c3.google.onReady()},onReady:function(){}});
h5c3.StyleSheet=h5c3.Base.extend("h5c3.StyleSheet",{_CLASSNAME:"Google",_CLASSVERSION:"0.1.0",_EMPCT:85,_FONTSIZE:16,_MODES:[{w:2560,f:19},{w:1920,f:18},{w:1600,f:17},{w:1440,f:16},{w:1366,f:15},{w:1280,f:14},{w:1024,f:13},{w:768,f:12},{w:480,f:11},{w:320,f:10}]},{useMQ:!0,appLayout:"",mode:2,mobile:null,reloadRedraw:!1,resizeTimer:0,init:function(){this._super();this.createMediaQueries();this.checkScreenMode();this.reviewResolution();this.initEvents();this.mobile=$DOC().createElement("div")},add:function(b,
c,e){""===c||(40>c.length||!$VLD(b)||!$VLD(e))||$GEI(b)||(c=$(c),$(c).data("role",e),e=$DOC().createElement("style"),e.id=b,e.type="text/css",e.innerHTML=$(c).text(),document.getElementsByTagName("head")[0].appendChild(e))},remove:function(b){$VLD(b)},reviewResolution:function(){if((d=$DOC().documentElement.dataset)&&h5c3.layout.isValid(d.layout))return this.appLayout=d.layout,"absolute-all"===this.appLayout?this.setResolution(window.innerWidth-400):this.setResolution()},initEvents:function(){$(window).resize(function(){clearTimeout(h5c3.stylesheet.resizeTimer);
h5c3.stylesheet.resizeTimer=setTimeout(h5c3.stylesheet._onResizeComplete,200)})},_onScreenSizeChanged:function(){2>this.mode?($("#RIGHTBAR").css({display:"none",width:"0"}),$("#CONTENT").css({right:"0"})):($("#RIGHTBAR").css({display:"block",width:"12.5em"}),$("#CONTENT").css({right:"12.5em"}));1>this.mode?($("#LEFTBAR").css({display:"none",width:"0"}),$("#CONTENT").css({left:"0"})):($("#LEFTBAR").css({display:"block",width:"15em"}),$("#CONTENT").css({left:"15em"}))},_onResizeComplete:function(){h5c3.stylesheet.checkScreenMode();
!0===this.reloadRedraw?h5c3.stylesheet.forceRedraw():h5c3.layout.reCalc()},forceRedraw:function(){$GEI("WRAPPER").style.display="none";location.reload()},checkScreenMode:function(){var b=this.mode;721>window.innerWidth&&0!=b?this.mode=0:720<window.innerWidth&&961>window.innerWidth&&1!=b?this.mode=1:960<window.innerWidth&&1921>window.innerWidth&&2!=b?this.mode=2:1920<window.innerWidth&&3!=b&&(this.mode=3);this.mode!=b&&this._onScreenSizeChanged()},getFontSize:function(){var b=$GEI("WRAPPER"),b=window.getComputedStyle(b,
null).getPropertyValue("font-size");return fontSize=parseFloat(b)},calcRWDValues:function(b){var c={scrn:b,gutter:1};c.em=this.getFontSize();this.mobile?c.full=c.outer=c.cellwidth=c.sixth=c.fourth=c.third=c.half=c.width=Math.floor(b/c.em):(c.width=Math.floor(b/c.em),c.full=c.outer=(0.9*b/c.em).toFixed(2),c.cellwidth=Math.floor(0.1*(c.outer-c.gutter)),c.sixth=(c.outer/6).toFixed(2),c.fourth=(c.outer/4).toFixed(2),c.third=(c.outer/3).toFixed(2),c.half=(c.outer/2).toFixed(2));c.cellheight=Math.floor(0.1*
(window.innerHeight/c.em-c.gutter));c.maxHeight=(window.innerHeight/c.em).toFixed(2);return c},onReady:function(){},createMediaQueries:function(){var b=14,c=((window.screen.availWidth-320)/10).toFixed(2),e='<style data-role="Application">\n';for(i=window.screen.availWidth;319<i;i-=c)e+="@media all and (max-width:"+i+"px) {body,#WRAPPER {font-size:"+b+"px;}}\n",b=(b-0.4).toFixed(2);this.add("Media-Queries",e+"</style>\n","R2WL")},setResolution:function(b){$VLD(b)||(b=window.innerWidth);b=this.calcRWDValues(b);
var c;c='<style data-role="Application">'+("body{font-size:"+b.em+"px;width: 100%;height: 100%;}");c+=".cell{min-height:"+b.cellheight+"em;max-height:"+b.cellheight+"em;min-width:"+b.cellwidth+"em;max-width:"+b.cellwidth+"em;margin:"+b.gutter+"em}";c+=".box{margin:"+b.gutter+"em}";c+=".lightbox{padding:"+b.gutter+"em;margin:"+b.gutter+"em}";c+=".full{min-width:"+b.width+"em;width:"+b.width+"em;margin:"+b.gutter+"em;}";c=c+".fill{min-width:100%;width:100%;min-width:100%;width:100%;margin:0em;}"+(".half{min-width:"+
b.half+"em;width:"+b.half+"em;}");c+=".third{min-width:"+b.third+"em;width:"+b.third+"em;}";c+=".fourth{min-width:"+b.fourth+"em;width:"+b.fourth+"em;}";c+=".sixth{min-width:"+b.sixth+"em;width:"+b.sixth+"em;}";2!=this.mode?(c+=".pct100 {width:100%;}\n",c+=".pct90 {width:100%;}\n",c+=".pct80 {width:100%;}\n",c+=".pct70 {width:100%;}\n",c+=".pct60 {width:100%;}\n",c+=".pct50 {width:100%;}\n",c+=".pct40 {width:100%;}\n",c+=".pct30 {width:100%;}\n",c+=".pct20 {width:100%;}\n",c+=".pct10 {width:100%;}\n"):
(c+=".pct100 {width:"+b.width+"em;}\n",c+=".pct90 {width:"+(0.9*b.width).toFixed(2)+"em;}\n",c+=".pct80 {width:"+(0.8*b.width).toFixed(2)+"em;}\n",c+=".pct70 {width:"+(0.7*b.width).toFixed(2)+"em;}\n",c+=".pct60 {width:"+(0.6*b.width).toFixed(2)+"em;}\n",c+=".pct50 {width:"+(0.5*b.width).toFixed(2)+"em;}\n",c+=".pct40 {width:"+(0.4*b.width).toFixed(2)+"em;}\n",c+=".pct30 {width:"+(0.3*b.width).toFixed(2)+"em;}\n",c+=".pct20 {width:"+(0.2*b.width).toFixed(2)+"em;}\n",c+=".pct10 {width:"+(0.1*b.width).toFixed(2)+
"em;}\n");c+="[class*='pct'] {float:left;min-height:3em;min-width:4em}\n";c+="#waDIV {width:48em; height:27em;position:relative;}\n";c+="#waCanvas {width:100%;height:100%;}\n";c+=".h5c3_applet {width:0px;height:0px;display:none;}\n";c+="#HEADER.normal,.HEADER,#LEFTBAR.normal,.LEFTBAR,#RIGHTBAR.normal,.RIGHTBAR,#FOOTER.normal,.FOOTER { background: rgba(255, 255, 255, 0.85); color: rgba(60, 100, 190, 0.85); }\n";c+="#HEADER.light,.HEADER,#LEFTBAR.light,.LEFTBAR,#RIGHTBAR.light,.RIGHTBAR,#FOOTER.light,.FOOTER { background: rgba(255, 255, 255, 0.85); color: rgba(60, 100, 190, 0.85); }\n";
c+="#HEADER.dark,.HEADER,#LEFTBAR.dark,.LEFTBAR,#RIGHTBAR.dark,.RIGHTBAR,#FOOTER.dark,.FOOTER { background: rgba(255, 255, 255, 0.85); color: rgba(60, 100, 190, 0.85); }\n";c+="#HEADER.desert,.HEADER,#LEFTBAR.desert,.LEFTBAR,#RIGHTBAR.desert,.RIGHTBAR,#FOOTER.desert,.FOOTER { background: rgba(255, 255, 255, 0.85); color: rgba(60, 100, 190, 0.85); }\n";c+="#HEADER.pink,.HEADER,#LEFTBAR.pink,.LEFTBAR,#RIGHTBAR.pink,.RIGHTBAR,#FOOTER.pink,.FOOTER { background: rgba(255, 255, 255, 0.85); color: rgba(60, 100, 190, 0.85); }\n";
c+="#HEADER.i2tm,.HEADER,#LEFTBAR.i2tm,.LEFTBAR,#RIGHTBAR.i2tm,.RIGHTBAR,#FOOTER.i2tm,.FOOTER { background: rgba(255, 255, 255, 0.85); color: rgba(60, 100, 190, 0.85); }\n";c+="</style>\n";this.add(this.appLayout,c,"R2WL")}});
window.h5c3.Layout=h5c3.Base.extend("h5c3.Layout",{_CLASSNAME:"Layout",_CLASSVERSION:"0.1.0",_layouts:["standard","landing","absolute-all"]},{noName:null,init:function(b){this._super();$CHK(b,{name:"absoluteAll"})},isValid:function(b){if(!$VLD(b))return!1;b.toLowerCase();return arraycontainsturtles=-1<this.Class._layouts.indexOf(b)},setLayout:function(b){$CHK(b,"");b.camelize("-");"function"===typeof b&&this.$name()},reCalc:function(){},onReady:function(){},absoluteAll:function(){h5c3.stylesheet.add("absolute-all",
$css,"Layout");var b;b='<div id="WRAPPER" data-type="application" data-layout="absolute-all">\n<div id="HEADER" ></div>\n<div id="CONTENT">\n';b+='<div id="LEFTBAR"></div>\t\n';b+='<div id="VIEWPORT"></div>\n';b+='<div id="RIGHTBAR"></div>\n';b+="</div>\x3c!-- CONTENT --\x3e\n";b+='<div id="FOOTER"></div>\n';b+="</div>\n";$("body").append(b)}});
window.h5c3.SmartMenu=h5c3.Base.extend("h5c3.SmartMenu",{_CLASSNAME:"SmartMenu",_CLASSVERSION:"0.0.1"},{$_menu:null,init:function(){this._super();"object"===typeof h5c3.config.smartmenu&&(this.$_menu=h5c3.config.smartmenu)}});
h5c3.Applet=h5c3.Pooled.extend("h5c3.Applet",{_CLASSNAME:"Applet",_CLASSVERSION:"0.1.0",params:{required:["role","name","version","uuid"],optional:["author","copyright","scale"]},create:function(b){var c=this._super();return c.parse(b)?c:c.name}},{style:"",script:"",html:"",src:null,name:null,version:"",uuid:"",role:"",author:"",copyright:"",created:0,accessed:0,ready:!1,loaded:!1,active:!1,init:function(){this._super()},me:function(){return this.uniqueId+" : "+this.name+" v"+this.version+"("+this.uuid+
")"},embed:function(b){this.active||(tmp=$("div[data-applet='"+this.name+"']").append(b),this.active=!0,this.setDraggable())},unbed:function(){this.active&&(this.active=!1)},compile:function(b){return h5c3.lzw.encode(encodeURIComponent(b))},decompile:function(b){return h5c3.lzw.decode(encodeURIComponent(b))},validUUID:function(b){if($VLD(b)&&""!==b&&4==b.split("-").length-1){if("1"==b.charAt(4)&&"9"==b.charAt(17)&&"6"==b.charAt(22)&&"9"==b.charAt(30))return!0;if("file:"===location.protocol&&h5c3.config.devMode)return console.log("Thats a bad UUID! Here is a good one "+
this.generateUUID()),!1}},generateUUID:function(){return"xxxx1xxx-xxxx-4xx9-yxx6-xxxxxx9xxxxx".replace(/[xy]/g,function(b){var c=16*Math.random()|0;return("x"==b?c:c&3|8).toString(16)})},setDraggable:function(){$(function(){$("#VIEWPORT").on("mousedown","div",function(){!0===this.draggable?($(this).addClass("draggable"),$(this).addClass("dragging").parents().on("mousemove",function(b){$(".dragging").offset({top:b.pageY-$(".dragging").outerHeight()/2,left:b.pageX-$(".dragging").outerWidth()/2}).on("mouseup",
function(){$(this).removeClass("dragging")});"undefined"!=typeof b&&b.preventDefault()})):($(".draggable").removeClass("draggable"),$(this).removeClass("dragging"))}).on("mouseup",function(){$(".draggable").removeClass("draggable")})})},parse:function(b){if(!this.parseHeader(b))return!1;b=$(b).not("comment").not("text");for(i=0;i<b.length;i++)"applet"===b[i].dataset.role&&"content"===b[i].dataset.type?this.html=b[i].outerHTML:"applet"===b[i].dataset.role&&"style"===b[i].dataset.type?this.style=b[i].outerHTML:
"applet"===b[i].dataset.role&&"script"===b[i].dataset.type&&(this.script=b[i].outerHTML);this.style&&h5c3.stylesheet.add(this.name,this.style,"Applet");this.script&&h5c3.stylesheet.add(this.name,this.script,"Applet");this.html&&this.embed(this.html);return!0},parseHeader:function(b){this.role=$(b).attr("data-role");this.name=$(b).attr("data-name");this.version=$(b).attr("data-version");this.uuid=$(b).attr("data-uuid");this.author=$(b).attr("data-author");this.copyright=$(b).attr("data-copyright");
this.scale=$(b).attr("data-scale");return $VLD(this.role)&&$VLD(this.name)&&$VLD(this.version)&&$VLD(this.uuid)?($good=this.validUUID(this.uuid))?!0:!1:!1},makeHeader:function(b,c,e,f){$VLD(b)||(b="applet");$VLD(c)||(c="Noname");$VLD(e)||(e="0.0.1");$VLD(f)&&$this.validUUID(f)||(f=this.generateUUID());b="<div "+('\tdata-role="'+b+'" ')+('\tdata-name="'+c+'" ');b+='\tdata-version="'+e+'" ';b+='\tdata-uuid="'+f+'" ';b+='\tdata-author="" ';b+='\tdata-copyright="" ';b+='\tdata-scale="1" ';return b+="/>\n"},
parseStyle:function(b){return $(b).filter("style").each(function(b){h5c3.stylesheet.add(this.name,this.outerHTML,"Applet");return this.outerHTML.toString()})},parseScript:function(b){return $(b).filter("script").each(function(b){h5c3.stylesheet.add(this.name,this.outerHTML,"Applet");return this.outerHTML.toString()})},verify:function(b,c){var e,f="Validating->";e=0;$VLD(b.dataset.role)||(f+="Missing data-role->",c?(b.dataset.role="applet",f+="Fixed->"):e++);$VLD(b.dataset.name)?""===b.dataset.name&&
(f+="data-name is empty->",c?(b.dataset.name="GIVE_ME_A_NAME",f+="Fixed->"):e++):(f+="Missing data-name->",c?(b.dataset.name="GIVE_ME_A_NAME",f+="Fixed->"):e++);$VLD(b.dataset.version)?""===b.dataset.version&&(f+="data-version is empty->",c?(b.dataset.name="0.0.1",f+="Fixed->"):e++):(f+="Missing data-version->",c?(b.dataset.version="0.0.1",f+="Fixed->"):e++);this.validUUID(b.dataset.uuid)||(f+="Missing data-uuid->",c?f=(b.dataset.uuid=this.generateUUID())?f+"Created UUID->":f+"Aborted: Unable to generateUUID.":
e++);f=(0===e&&!0!=c?f+"PERFECT!->":f+("Failed ("+e+") issues->"))+"Done.";return{result:e,message:f,applet:b}}});
h5c3.AppletFactory=h5c3.Factory.extend("h5c3.AppletFactory",{_CLASSNAME:"AppletFactory",_CLASSVERSION:"0.3.0",getAppletPath:function(b){return b&&""!=h5c3.config.options.path?h5c3.config.options.path+"applets/":h5c3.path.home+h5c3.path.applets}},{_scanned:[],_history:[],_loadQue:[],started:!1,_tracker:{failed:0,loading:0,loaded:0,fromConn:0,fromCache:0,loops:0,indexed:!1},throttle:null,init:function(){this._super("Applet")},create:function(b){return this.requestApplet(b)},add:function(b,c){this._super(b,
c)},reset:function(){this._loadQue=[];this._tracker={failed:0,loading:0,loaded:0,fromConn:0,fromCache:0,loops:0}},stop:function(){this.started=!1},start:function(){this.started||(this.reset(),this.started=!0)},onHREFClick:function(b){try{var c=h5c3.applets.use({name:this.name});c&&"0"!=$("#VIEWPORT").css("opacity")&&(h5c3.applets.scanHTML(c.html),this.lastContent=$GEI("VIEWPORT").innerHTML,$("#VIEWPORT").fadeOut(250,function(){$GEI("VIEWPORT").innerHTML=c.html;$("#VIEWPORT").fadeIn(250,"linear")}))}catch(e){$AST(null,
printStackTrace({e:e}))}},scanAnchors:function(b){var c=0,e=0,f=0;b=$VLD(b)?$(b):$("body");if(""!=b[0].id&&(b=b[0].id,-1!=this._scanned.indexOf(b)))return!0;b=$GET("a");for(i=0;i<b.length;i++)if(""!=b[i].hash){var g=b[i].hash.split(".");"#applet"==g[0]&&""!=g[1]&&(b[i].addEventListener("click",this.onHREFClick,!1),-1===this._scanned.indexOf(g[1])?(this._loadQue.push(g[1]),this._scanned.push(g[1]),f++):e++,b[i].name=g[1],c++)}return c},scanHTML:function(b){var c;$VLD(b)?(b=$(b),c=!1):(b=$("body"),
c=!0);b=$(b).find("div").filter(function(b){return void 0!==$(this).data("applet")});for(i=0;i<b.length;i++)b[i].style.display=!0===c?"block":"none",this._loadQue.push(b[i].dataset.applet);this._tracker.loading=this._loadQue.length},checkQue:function(){if(0>=this._loadQue.length)return!0;2<this._loadQue.length&&(this._loadQue=this._loadQue.filter(function(b,e){return h5c3.applets._loadQue.indexOf(b)==e}));this._tracker.loading=this._loadQue.length;var b=this._loadQue.shift();this.requestApplet({name:b})},
requestApplet:function(b){if(!$VLD(b))return!1;var c=this._history[b.name];if("undefined"!=typeof c){this._tracker.fromCache++;if($VLD(c.div))this.onLoad(c.div);this.checkQue();return!0}this._history[b.name]={name:b.name,src:this.Class.getAppletPath(1)+"applet."+b.name+".html",div:b.div};try{h5c3.XHR(this._history[b.name].src,h5c3.bind(this,this.onLoad),h5c3.bind(this,this.onError))}catch(e){$AST(null,printStackTrace({e:e}))}},_checkAllDone:function(){if(0>=this._loadQue.length)return this.stop(),
!0;this.checkQue();this._tracker.loops++;return this._tracker.loops>this._tracker.loading?!0:!1},onLoad:function(b){if(""===b)return!1;this._tracker.loaded++;this._tracker.loading--;b=h5c3.Applet.create(b);"object"===typeof b?(this._tracker.fromConn++,this._history[b.name].src&&(b.src=this._history[b.name].src),this.scanHTML(b.html),this.scanAnchors(b.html),$result=h5c3.applets.add(b.name,b)):(this._tracker.failed++,delete this._history[b],this.remove(b),$result=!1);this.started=!this._checkAllDone();
return $result},onError:function(b){return null},onReady:function(){this.started||(this.scanHTML(),this.scanAnchors(),this.checkQue())}});
...
window.h5c3.Resources=h5c3.Base.extend("h5c3.Resources",{_CLASSNAME:"Resources",_CLASSVERSION:"0.3.3"},{resources:null,init:function(){this._super();this.loadResources()},loadResources:function(){this.loadGraphics();this.loadAudio()},loadGraphics:function(){if($VLD(window.h5c3.config.resources)){var b,c=window.h5c3.config.resources.images;for(b=0;b<c.length;++b)h5c3.loader.add(new h5c3.Image(c[b].name,c[b].file))}},loadAudio:function(){if($VLD(window.h5c3.config.resources)){var b,c,e,f=window.h5c3.config.resources.sounds;
for(b=0;b<f.length;b++)c="true"===f[b].ogg?"ogg":"",e="true"===f[b].mp3?"mp3":"",h5c3.loader.add(new h5c3.Sound(f[b].name,f[b].file,[c,e],f[b].channels))}}});h5c3.SCREEN_CELLS={GRIDX1:0,GRIDX2:1,GRIDX3:2,GRIDX4:4,GRIDX5:8};
