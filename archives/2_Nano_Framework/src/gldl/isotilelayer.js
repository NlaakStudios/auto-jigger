 ...
 * var myTileLayer = new $m.df.IsoTileLayer('my tile layer', true, tileMap);
 * </code></pre>
 * <p>
 ...
 * @class $m.df.IsoTileLayer
 */
$m.df.IsoTileLayer = $m.df.TileLayer.extend("IsoTileLayer",
  {
    /**
    ...
    loadFromTMX: function (scene, layerXML, tileWidth, tileHeight, tileSets) {
      ...
      var newLayer = new $m.df.IsoTileLayer(name, true, null, tileSets);
  ...
  },
  {
    ...
    init: function (name, usePrerendering, tileMap, tileSets) {
      this._super(name, $m.df.checked(usePrerendering, false), tileMap, tileSets);
    },
     ...
     * @return {number} X coordinate relative to the layer for the center of the tile
     */
     ...
     * @param tileX Tile column
     * @param tileY Tile row
     * @return {number} X coordinate relative to the left of the screen/viewport
     */
     ...
     * @param tileX Tile column
     * @param tileY Tile row
     * @return {number} Y coordinate relative to the layer origin
     */
     ...
     * @param tileX Tile column
     * @param tileY Tile row
     * @return {number} Y coordinate relative to the top of the screen/viewport
     */
     ...
     * @return {number} World tile x coordinate in tiles
     */
