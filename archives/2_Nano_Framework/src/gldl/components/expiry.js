 ...
 * @class $m.df.components.Expiry
 */
$m.df.components.Expiry = $m.df.components.Component.extend('$m.df.components.Expiry',
    /** @lends $m.df.components.Expiry */
    {
        /**
         * Constructs (or acquires from the pool) an expiry component.
         * @param {Number} options.lifetime Life time before expiry (in ms)
         * @return {$m.df.components.Expiry} The shiny new component
         */
    ...
    /** @lends $m.df.components.Expiry.prototype */
    {
