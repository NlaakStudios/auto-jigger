 ...
 * See the <a href='$m.df.components.Activator'>activator component</a> for more information.
 * @module GLDL
 * @submodule Systems
 * @class $m.df.systems.Activation
 */
$m.df.systems.Activation = $m.df.systems.EntitySystem.extend('$m.df.systems.Activation',
    /** @lends $m.df.systems.Activation */
    {},
    /** @lends $m.df.systems.Activation.prototype */
    {
        /**
