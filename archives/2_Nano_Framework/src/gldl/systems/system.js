 ...
 * @module GLDL
 * @submodule Systems
 * @class $m.df.systems.System
 */
$m.df.systems.System = $m.df.Base.extend('$m.df.System',
    /** @lends $m.df.systems.System */
    { },
    /** @lends $m.df.systems.System.prototype */
    {
        ...
        {
            this._super();
            this.delay = $m.df.checked(delay, 0);
