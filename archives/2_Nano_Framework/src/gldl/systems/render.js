 ...
 * @module GLDL
 * @submodule Systems
 * @class $m.df.systems.Render
 */
$m.df.systems.Render = $m.df.systems.EntitySystem.extend('$m.df.systems.Render',
    /** @lends $m.df.systems.Render */
    {},
    /** @lends $m.df.systems.Render.prototype */
    {
        /**
        ...
        processAll: function()
        {
            ...
            while (next)
            {
                ...
                if (entity.active)
                {
                    ...
                    {
                        spriteComponent.sprite.update(gldl.device.elapsed);
                    ...
                    if (circle && circle.active)
                    {
                        ...
                        ctx.beginPath();
                        ctx.arc(0, 0, spatial.dim.x / 2, 0, $m.df.Math.PI * 2, true);
                        ctx.closePath();
            ...
            gldl.device.lastDrawMS += (Date.now() - startTime);
        }
