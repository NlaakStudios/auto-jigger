 ...
 * <pre><code>
 * var zombieSprite = new $m.df.Sprite( zombieSpriteSheet );
 * </code></pre>
 ...
 * <pre><code>
 * zombieSprite.draw(gldl.device.ctx, 100, 100);
 * </code></pre>
 * To cycle animations, call update:
 * <pre><code>
 * zombieSprite.update(gldl.device.elapsed);
 * </code></pre>
 * <p>
 ...
 * @class $m.df.Sprite
 */
$m.df.Sprite = $m.df.Pooled.extend('$m.df.Sprite',
    /** @lends $m.df.Sprite */
    {
        /**
         * Construct a new sprite object by acquiring it from the free pool and configuring it
         * @param {$m.df.SpriteSheet} spriteSheet Sprite sheet to use
         * @return {$m.df.Sprite} A sprite object
         */
    ...
    /** @lends $m.df.Sprite.prototype */
    {
        /** Current animation frame */
        currentFrame:0,
        /** Current animation object reference */
        currentAnim:null,
        /** $m.df.SpriteSheet used by this sprite */
        spriteSheet:null,
         ...
         * @param {$m.df.SpriteSheet} spriteSheet Spritesheet to use
         */
         ...
         * @param {$m.df.SpriteSheet} spriteSheet Spritesheet to configure with
         */
        config: function(spriteSheet)
        {
            this.spriteSheet = $m.df.checked(spriteSheet, null);
            if (this.spriteSheet)
                this.reset();
        },
         ...
         * @param {$m.df.SpriteSheet} spriteSheet Sprite sheet to change to
         */
        ...
        setAnimation:function (name, speedOffset, force)
        {
            ...
            this.active = true;
            this.held = false;
            this.animSpeedOffset = $m.df.checked(speedOffset, 0);
