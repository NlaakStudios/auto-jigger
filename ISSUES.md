...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in the project, creating a new issue in the `NlaakStudios/auto-jigger`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `NlaakStudios/auto-jigger` in a concrete and reviewable manner.

## Submitting a Bug Report

When opening a new issue in the `NlaakStudios/auto-jigger` issue tracker, users will be
...
This issue tracker is for bugs and issues found within auto-jigger project.
If you require more general support please file an issue on our help
repo. https://github.com/NlaakStudios/auto-jigger/help
...
If you believe that you have uncovered a bug in the project, please fill out this
...
cases should be limited, as much as possible, to using *only* the master code.
...
master changed that broke the module.
...
[auto-jigger help repository]: https://github.com/NlaakStudios/auto-jigger/help/issues